...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="<?php echo base_url()?>index.html" class="logo d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="<?php echo base_url()?>index.html">Blog</a></li>
          <li><a href="<?php echo base_url()?>single-post.html">Single Post</a></li>
          <li class="dropdown"><a href="<?php echo base_url()?>category.html"><span>Categories</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="<?php echo base_url()?>search-result.html">Search Result</a></li>
              <li><a href="<?php echo base_url()?>#">Drop Down 1</a></li>
              <li class="dropdown"><a href="<?php echo base_url()?>#"><span>Deep Drop Down</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
                  <li><a href="<?php echo base_url()?>#">Deep Drop Down 1</a></li>
                  <li><a href="<?php echo base_url()?>#">Deep Drop Down 2</a></li>
                  <li><a href="<?php echo base_url()?>#">Deep Drop Down 3</a></li>
                  <li><a href="<?php echo base_url()?>#">Deep Drop Down 4</a></li>
                  <li><a href="<?php echo base_url()?>#">Deep Drop Down 5</a></li>
                </ul>
              </li>
              <li><a href="<?php echo base_url()?>#">Drop Down 2</a></li>
              <li><a href="<?php echo base_url()?>#">Drop Down 3</a></li>
              <li><a href="<?php echo base_url()?>#">Drop Down 4</a></li>
            </ul>
          </li>
      ...
      <div class="position-relative">
        <a href="<?php echo base_url()?>#" class="mx-2"><span class="bi-facebook"></span></a>
        <a href="<?php echo base_url()?>#" class="mx-2"><span class="bi-twitter"></span></a>
        <a href="<?php echo base_url()?>#" class="mx-2"><span class="bi-instagram"></span></a>
