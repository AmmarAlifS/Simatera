    ...
    <div class="container" data-aos="fade-up">
      <div class="row justify-content-between align-items-lg-center">
        <div class="col-lg-5 mb-4 mb-lg-0">
          ...
          ?>
          <p><a href="<?php echo base_url();?>guest/list" class="more">Lihat Semua Posting Lainnya</a></p>
        </div>
        <div class="col-lg-6">
          <div class="row">
            <div href="#" class="me-4 thumbnail">
        ...
        <div class="row">
          <div class="col-12 text-center mb-5">
            <div class="row justify-content-center">
              <div class="col-lg-6">
                <h2 class="display-4">Simatera Team</h2>
                <p></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 text-center mb-5">
            <img src="<?php echo base_url()?>assets/img/default.png" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4>Rendy Riansyah</h4>
            <!-- <span class="d-block mb-3 text-uppercase">Founder &amp; CEO</span> -->
            <span class="d-block mb-3 text-uppercase">Universitas Widyatama</span>
            <p></p>
          </div>
          <div class="col-lg-4 text-center mb-5">
            <img src="<?php echo base_url()?>assets/img/default.png" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4>Arrijal Mutaqin</h4>
