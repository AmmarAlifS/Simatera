            ...
            <div class="col-lg-3 col-md-4">
              ...
              <div class="aside-block">
                ...
                <div class="video-post">
                  <a href="https://www.youtube.com/watch?v=dQw4w9WfgXcQ" class="glightbox link-video">
                    <span class="bi-play-fill"></span>
                    <img src="<?php echo base_url(); ?>assets/img/pemandian-cihampelas.jpg" alt="" class="img-fluid" />
                  </a>
                </div>
              </div>
              <!-- End Video -->
...
<style type="text/css">
  ...
  .custom-pagination {
    ...
    margin: 0 5px;
    /* Add space between the page links */
  }
  ...
  .custom-pagination .page-link.active {
    ...
    /* Increase the border width to 4px */
    padding: 5px 10px;
    /* Add padding around the link */
    text-align: center;
    /* Center the text */
