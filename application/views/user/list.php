                  ...
                  <div class="row">
                    ...
                    <div class="<?php echo $post_entry_class ?>">
                      <div class="post-entry-1">
                        <a href="<?php echo base_url().'user/single_post/'.$row->id_artikel;?>"><img src="<?php echo base_url()?>assets/img/<?php echo $row->Foto ?>" alt="" class="img-fluid post-thumbnail" style="width: 100%; height: 200px;"></a>
                        <div class="post-meta"> <span><?php echo $row->tanggal ?></span></div>
                        <h2><a href="<?php echo base_url().'user/single_post/'.$row->id_artikel;?>" style="font-family: inherit; font-weight: bold;"><?php echo $row->judul ?></a></h2>
