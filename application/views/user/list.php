                  ...
                  foreach ($artikel as $row) :
                    ...
                    <div class="<?php echo $post_entry_class ?>">
                      <div class="post-entry-1">
                        ...
                        <a href="<?php echo base_url().'user/single_post/'.$row->id_artikel;?>"><button class="btn btn-primary">Baca selengkapnya</button></a>
                      </div>
                    </div>
                    ...
                    <?php foreach($limited_art as $row): ?>
                      <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                        <div class="post-entry-3 border-bottom">
                          <div class="post-meta-3"><span class="date"><?php echo $row->kategori ?></span> <span class="mx-1">&bullet;</span> <span><?php echo $row->tanggal; ?></span></div>
